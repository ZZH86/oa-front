  ...
  methods: {
    ...
    wechatLogin() {
      ...
      if(token === '' && openId != '') {
        ...
        if (token == '') {
          ...
          window.location = 'http://oach.vipgz1.91tunnel.com/admin/wechat/authorize?returnUrl=' + url
        }
      }
    },
    ...
    saveBind() {
      ...
      userInfoApi.bindPhone(this.bindPhoneVo).then(response => {
        ...
        window.location = 'http://oach9090.gz2vip.91tunnel.com'
      })
    },
